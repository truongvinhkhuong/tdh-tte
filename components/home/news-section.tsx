            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div ref={ref} className={`transition-all duration-1000 ${isVisible ? "opacity-100" : "opacity-0"}`}>
                        ...
                        {latestNews.map((article, index) => (
                            ...
                            >
                                <div className="relative h-48 bg-gray-200 overflow-hidden">
                                    ...
                                    {/* Category Badge */}
                                    <div className="absolute top-4 left-4 px-3 py-1 bg-gradient-to-r from-[#364fa1] to-[#5a7ec9] text-white text-xs font-svn-avo-extra-bold rounded-full">
                                ...
                                <div className="p-6">
                                    ...
                                    <h3 className="text-lg font-svn-avo-extra-bold text-gray-900 mb-3 line-clamp-2 group-hover:text-[#364fa1] transition-colors">
                                        {article.title}
                                    </h3>
                                    ...
                                    <span className="inline-flex items-center gap-1 text-[#364fa1] font-svn-avo-extra-bold text-sm group-hover:gap-2 transition-all">
                                        {dict.news.readMore}
                                        <ArrowRight size={16} />
                                    </span>
                                </div>
                    ...
                    <div className="text-center mt-12">
                        <Link
                            href={`/${lang}/news`}
                            className="inline-flex items-center gap-2 px-8 py-3 border-2 border-[#364fa1] text-[#364fa1] font-svn-avo-extra-bold rounded-xl hover:bg-[#364fa1] hover:text-white transition-all duration-300"
                        >
