...
export const brands: Brand[] = [
    ...
    },
    {
        ...
        name: 'Cameron',
        logo: '/placeholder-logo.svg',
        description: 'Schlumberger company - Flow equipment manufacturer',
    },
    {
        id: '4',
        slug: 'dresser',
    ...
    },
    {
        ...
        name: 'Fisher',
        logo: '/placeholder-logo.svg',
        description: 'Control valve and regulator manufacturer',
    },
];
...
export const timeline: TimelineMilestone[] = [
    {
        ...
        description: 'Công ty Kỹ thuật Toàn Thắng được thành lập tại TP. Hồ Chí Minh.',
    },
    {
        year: 1998,
        title: 'Mở rộng Kinh doanh',
        description: 'Trở thành đại lý chính thức của Emerson tại Việt Nam.',
    },
    {
        year: 2005,
        title: 'Chứng nhận ISO',
        description: 'Đạt chứng nhận ISO 9001:2000 về hệ thống quản lý chất lượng.',
    },
    {
        year: 2010,
        title: 'Dự án Lớn đầu tiên',
        description: 'Hoàn thành dự án cung cấp thiết bị cho Nhà máy Đạm Cà Mau.',
    },
    {
        year: 2015,
        title: 'Cổ phần hóa',
        description: 'Chuyển đổi thành Công ty Cổ phần Kỹ thuật Toàn Thắng.',
    },
    {
        year: 2020,
        title: 'Mở rộng Dịch vụ',
        description: 'Ra mắt dịch vụ bảo trì và hỗ trợ kỹ thuật 24/7.',
    },
    {
        year: 2023,
        title: 'Kỷ niệm 30 năm',
        description: 'Kỷ niệm 30 năm thành lập với hơn 500 dự án thành công.',
    },
];
